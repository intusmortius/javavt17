        ...
        <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-primary">
                ...
                <div class="alert alert-info" role="alert">
                    <a class="btn btn-primary" role="button" href="${pageContext.request.contextPath}/pdfReport?view=pdfView" target="_blank">Download PDF report</a>
                    <a class="btn btn-primary" role="button" href="${pageContext.request.contextPath}/xlsxReport.xlsx?view=excelView" target="_blank">Download Excel report</a>
                </div>
                <div class="panel-body">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-footer"><a class="btn btn-info" role="button" href="${pageContext.request.contextPath}/${instrument}/newBrand">Add new brand &raquo</a></div>
                    </div>
                    ​
                    <div class="panel panel-info">
                        <!-- Default panel contents -->
                        ...
                        <div class="panel-footer"><a class="btn btn-info" role="button" href="${pageContext.request.contextPath}/${instrument}/newModel">Add new model &raquo</a></div>
                    </div>
                </div>
            </div>
        </div>
